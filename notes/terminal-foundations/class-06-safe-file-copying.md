...
- `cp` means copy.
- In `cp notes.txt notes-copy.txt`, `notes.txt` is the original source file and `notes-copy.txt` is the new copy.
- Analysts preserve original evidence and examine copies, helping to avoid tampering with the original file.
